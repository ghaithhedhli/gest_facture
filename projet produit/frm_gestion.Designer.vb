...
Partial Class frm_gestion
    ...
    Private Sub InitializeComponent()
        ...
        Label1.Location = New Point(324, 33)
        ...
        Label4.Location = New Point(326, 166)
        ...
        ' btn_supprimer
        ' 
        btn_supprimer.Location = New Point(799, 72)
        btn_supprimer.Name = "btn_supprimer"
        btn_supprimer.Size = New Size(174, 39)
        ...
        ' btn_vider
        ' 
        btn_vider.Location = New Point(799, 126)
        btn_vider.Name = "btn_vider"
        btn_vider.Size = New Size(174, 35)
        ...
        ' btn_modifier
        ' 
        btn_modifier.Location = New Point(799, 167)
        btn_modifier.Name = "btn_modifier"
        btn_modifier.Size = New Size(174, 38)
        ...
        Label5.Location = New Point(73, 225)
        Label5.Name = "Label5"
        ...
        Label6.Location = New Point(320, 225)
        Label6.Name = "Label6"
        ...
        Label8.Location = New Point(799, 225)
        Label8.Name = "Label8"
        ...
        lst_p.ItemHeight = 30
        lst_p.Location = New Point(50, 267)
        lst_p.Name = "lst_p"
        lst_p.Size = New Size(139, 214)
        lst_p.TabIndex = 16
        ' 
        ' lst_pu
        ' 
        lst_pu.FormattingEnabled = True
        lst_pu.ItemHeight = 30
        lst_pu.Location = New Point(320, 267)
        lst_pu.Name = "lst_pu"
        lst_pu.Size = New Size(145, 214)
        lst_pu.TabIndex = 17
        ' 
        ' lst_q
        ' 
        ...
        lst_q.ItemHeight = 30
        lst_q.Location = New Point(559, 267)
        lst_q.Name = "lst_q"
        lst_q.Size = New Size(145, 214)
        lst_q.TabIndex = 18
        ' 
        ' lst_m
        ' 
        ...
        lst_m.ItemHeight = 30
        lst_m.Location = New Point(799, 267)
        lst_m.Name = "lst_m"
        lst_m.Size = New Size(145, 214)
        lst_m.TabIndex = 19
        ' 
        ' btn_total
        ' 
        btn_total.AutoSize = True
        btn_total.Location = New Point(103, 525)
        btn_total.Name = "btn_total"
        btn_total.Size = New Size(76, 30)
        btn_total.TabIndex = 20
        btn_total.Text = "Total :"
        ' 
        ' txt_tpu
        ' 
        txt_tpu.Location = New Point(318, 519)
        txt_tpu.Name = "txt_tpu"
        txt_tpu.Size = New Size(145, 36)
        txt_tpu.TabIndex = 21
        ' 
        ' txt_tq
        ' 
        txt_tq.Location = New Point(559, 519)
        txt_tq.Name = "txt_tq"
        txt_tq.Size = New Size(145, 36)
        txt_tq.TabIndex = 22
        ' 
        ' txt_tm
        ' 
        txt_tm.Location = New Point(799, 519)
        txt_tm.Name = "txt_tm"
        txt_tm.Size = New Size(145, 36)
        txt_tm.TabIndex = 23
        ' 
        ' btn_tva
        ' 
        btn_tva.AutoSize = True
        btn_tva.Location = New Point(103, 589)
        btn_tva.Name = "btn_tva"
        btn_tva.Size = New Size(129, 30)
        btn_tva.TabIndex = 24
        btn_tva.Text = "TVA(20%) :"
        ' 
        ' txt_tva
        ' 
        txt_tva.Location = New Point(320, 586)
        txt_tva.Name = "txt_tva"
        txt_tva.Size = New Size(324, 36)
        txt_tva.TabIndex = 25
        ' 
        ' txt_remise
        ' 
        txt_remise.Location = New Point(324, 642)
        txt_remise.Name = "txt_remise"
        txt_remise.Size = New Size(324, 36)
        txt_remise.TabIndex = 26
        ' 
        ' btn_remise
        ' 
        btn_remise.AutoSize = True
        btn_remise.Location = New Point(103, 648)
        btn_remise.Name = "btn_remise"
        btn_remise.Size = New Size(110, 30)
        btn_remise.TabIndex = 27
        btn_remise.Text = "  Remise :"
        ' 
        ' btn_calcul
        ' 
        btn_calcul.Location = New Point(345, 718)
        btn_calcul.Name = "btn_calcul"
        btn_calcul.Size = New Size(190, 62)
        ...
        ' btn_quitter
        ' 
        btn_quitter.Location = New Point(533, 718)
        btn_quitter.Name = "btn_quitter"
        btn_quitter.Size = New Size(190, 62)
